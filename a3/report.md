...
Παρατηρούμε ότι η transpose έκδοση του αλορίθμου παρουσίαζει βελτίωση σε σχέση με την naive έκδοση.Παρόλα αυτά βλέπουμε ξανά οτι το block size δεν παίζει κάποιο ιδιαίτερο ρόλο.

  Η transpose έκδοση βελτιώνει τον τρόπο με τον οποίο ανακτούνται τα δεδομένα απο την μνήμη.Αυτο συμβαίνει επειδή 
